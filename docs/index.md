---
page_title: "config-v1 Provider"
---

# config-v1 Provider

This provider is used to interact with the resources provided by the **config-v1** application of the [Nokia EDA](https://docs.eda.dev) platform.
